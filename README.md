...
10. 类属性、类实例方法、函数，如果是私有的，那么在名字前面加双下划线__xxx，否则不需要加任何下划线，不要使用名字前面加单下划线_xxx这种保护属性/函数/类实例方法，在实际项目中只需要区分私有和非私有，私有就在名字前加双下划线，非私有就不需要在名字前加任何下划线  
